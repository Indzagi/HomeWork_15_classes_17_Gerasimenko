...
public class Interceptor extends SpaceShipAbstract {
    ...
    public void hyperJump() {
        System.out.println(String.format("%s включает гипер - двигатель для прыжка", getName()));
    }

    public void attack() {
        System.out.println(String.format("%s Атакует корабль противника", getName()));
    }
