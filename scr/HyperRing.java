...
public class HyperRing{
    private SpaceShipAbstract spaceShip;

    public HyperRing(SpaceShipAbstract spaceShip) {
        this.spaceShip = spaceShip;
    }

    private void fixTheSpaceShip(SpaceShipAbstract spaceShip) {
        System.out.println(String.format("%s зафиксирован за гипер - кольцом" +
                " с помощью магнитных захватов", spaceShip.getName()));

    }

    public void doHyperJump() {
        fixTheSpaceShip(spaceShip);
        spaceShip.hyperJump();
        System.out.println(String.format("%s делает гипер - прыжок",spaceShip.getName()));
    }
}
